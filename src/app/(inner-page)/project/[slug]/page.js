          ...
          <div className="row">
            <div className="col-12">
              <div className="big-bg-porduct-details">
                <img
                  src={`/assets/images/product/${ProjectPost.bannerImg}`}
          ...
          <div className="row mt--70 mb--50">
            <div className="col-12">
              <div className="product-details-main-inner">
                ...
                <p className="disc">
                  fasdvdavsdfvNetus platea nec commodo tincidunt felis orci iaculis
                  facilisi. Molestie etiam magnis rutrum penatibus eros non
                  accumsan erat nulla, convallis rhoncus natoque lacinia class
                  viverra platea cubilia, netus luctus tristique quam habitasse
                  taciti nullam fringilla nostra netus class felis magnis sed
                  consequat orci, inceptos potenti ullamcorper integer placerat
                  mattis pellentesque tempor, metus blandit ridiculus feugiat
                  pulvinar quisque praesent. Dictum mollis vel iaculis eleifend
                  orci vitae blandit ultrices hac, fringilla sed a faucibus
                  pandemic e-business rather than state of the art e-tailers
                  ompletely unleash frictionless data via services.{" "}
                </p>
                <p className="italic">
                  “Tortor nunc dictumst sapien inceptos libero natoque maecenas
                  metus viverra commodo dignissim magna, donec odio leo varius
                  nullam potenti porta facilisi vulputate sollicitudin montes
          ...
          <div className="row g-5">
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
              ...
              <div className="single-project-details-challenge">
                ...
                <p className="details">
                  Facilisi odio mus quam risus vestibulum torquent eleifend
                  integer semper ridiculus mi habitasse, imperdiet
                </p>
              </div>
              <div className="single-project-details-challenge">
                <div className="icon">
                ...
                <p className="details">
                  Laoreet mus quisque rhoncus himenaeos praesent enim tortor
                  life dapibus pharetra netus duis vel habitant
                </p>
              </div>
            </div>
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pr--80">
